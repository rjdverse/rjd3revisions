...
input_long_1 <- data.frame(
    ...
    time_period = rep(
        x = c("2022Q1", "2022Q2", "2022Q3", "2022Q4"),
        times = 8L
    ),
...
input_long_2 <- data.frame(
    ...
    time_period = c(rep(
        x = c("2022 T1", "2022 T2", "2022 T3", "2022 T4"),
        times = 8L
    )),
    obs_value = values_long,
    stringsAsFactors = FALSE
...
input_long_3 <- data.frame(
    ...
    time_period = rep(
        x = c("2022-01-01", "2022-04-01", "2022-07-01", "2022-10-01"),
        times = 8L
    ),
    obs_value = values_long,
    stringsAsFactors = FALSE
...
input_long_4 <- data.frame(
    ...
    time_period = c(rep(
        x = c("2022 Q1", "2022 Q2", "2022 Q3", "2022 Q4"),
        times = 8L
    )),
    obs_value = values_long,
    stringsAsFactors = FALSE
...
test_that("Creation of vintages works for all format", {
    vintage1 <- create_vintages(
        x = input_long_1,
        type = "long",
        periodicity = 4L
    )
    vintage2 <- create_vintages(
        x = input_long_2,
        type = "long",
        periodicity = 4L,
        date_format = "%d/%m/%Y"
    )
    vintage3 <- create_vintages(
        x = input_long_3,
        type = "long",
        periodicity = 4L
    )
    vintage4 <- create_vintages(
        x = input_long_4,
        type = "long",
        periodicity = 4L,
        date_format = "%m/%d/%y"
    ...
    vintage5 <- create_vintages(
        x = input_horizontal_1,
        type = "horizontal",
        periodicity = 4L
    )
    vintage6 <- create_vintages(
        x = input_horizontal_2,
        type = "horizontal",
        periodicity = 4L,
        date_format = "%d/%m/%Y"
    )
    vintage7 <- create_vintages(
        x = input_horizontal_3,
        type = "horizontal",
        periodicity = 4L
    )
    vintage8 <- create_vintages(
        x = input_horizontal_4,
        type = "horizontal",
        periodicity = 4L,
        date_format = "%m/%d/%y"
    )
    ...
    vintage10 <- create_vintages(
        x = input_vertical_2,
        type = "vertical",
        date_format = "%d/%m/%Y"
    )
    vintage11 <- create_vintages(
        x = input_vertical_3,
        type = "vertical",
        date_format = "%m/%d/%y"
    )
    vintage12 <- create_vintages(
        x = input_vertical_4,
        type = "vertical",
        periodicity = 4L
    )
    vintage13 <- create_vintages(
        x = input_vertical_5,
        type = "vertical",
        periodicity = 4L,
        date_format = "%d/%m/%Y"
    )
    vintage14 <- create_vintages(
        x = input_vertical_6,
        type = "vertical",
        periodicity = 4L
    )
    vintage15 <- create_vintages(
        x = input_vertical_7,
        type = "vertical",
        periodicity = 4L,
        date_format = "%m/%d/%y"
