...
vintages <- create_vintages(long_view, type = "long", periodicity = 4)
...
```{r revision analysis, echo = TRUE, eval = TRUE}
revisions <- get_revisions(vintages, gap = 1)
```
...
# render_report(rslt, output_path = "C:/User/report.pdf", output_format = "pdf_format")
