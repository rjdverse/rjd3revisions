...
if (! requireNamespace("kableExtra", quietly=TRUE)) {
  knitr::kable(descriptive_statistics[selection, , drop=FALSE], format="html")
  warning("Please install kableExtra: install.packages('kableExtra') to get more visual table output")
} else {
  kableExtra::kable_minimal(knitr::kable(descriptive_statistics[selection, , drop=FALSE], format="html"))
}
```
...
if (! requireNamespace("kableExtra", quietly=TRUE)) {
  ...
  main_results[, 2:nc]<-apply(main_results[, 2:nc, drop=FALSE], 2, format_font)
  kableExtra::kable_minimal(knitr::kable(main_results, format="html", escape = FALSE))
}
```
